...
- [ ] **Configuración Inicial**
  - [ ] Crear estructura de directorios siguiendo `noa-bot/` definido en el PRD (Sección 5).
...
- [ ] **Análisis de OpenAI**
  ...
  - [ ] Configurar Prompt del Sistema (Sección 7 PRD).
...
- [ ] **Análisis Avanzado**
  ...
  - [ ] Implementar scoring de leads (`Sección 7 PRD`).
